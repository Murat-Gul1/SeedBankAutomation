...
using DevExpress.XtraRichEdit; // PDF Çevirici için ŞART
using System;
using System.Data;
            ...
            using (var db = new TohumBankasiContext())
            {
                ...
                var raporlar = (from r in db.BitkiRaporlaris
                                ...
                                select new
                                {
                                    r.RaporId,
                                    kb.BitkiAdi,
                                    kb.GorselYolu, // Resim için
                                    r.RaporTarihi,
                                    r.RaporMetni // PDF yapmak için buna ihtiyacımız var (Gizli kalacak)
                                }).ToList();
                ...
                var gridVerisi = raporlar.Select(x => new
                {
                    ...
                    x.RaporTarihi,
                    x.RaporMetni,
                    Indir = "PDF" // Buton gibi görünecek sütun
                }).ToList();
